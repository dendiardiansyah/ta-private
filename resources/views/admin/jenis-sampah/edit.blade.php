    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Perbarui informasi jenis sampah</p>
            </div>
        </div>
    </x-slot>
                ...
                <form action="{{ route('admin.jenis-sampah.update', $jenisSampah) }}" method="POST"
                    ...
                    <div class="mb-6">
                        ...
                        @if ($jenisSampah->gambar)
                            <div class="mb-3">
                                <p class="text-xs text-gray-600 mb-2">{{ __('Gambar saat ini:') }}</p>
                                <img src="{{ asset('storage/' . $jenisSampah->gambar) }}"
                                    alt="{{ $jenisSampah->nama_jenis }}"
